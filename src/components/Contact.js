          ...
          <div className='flex gap-5 px-20 max-xl:flex-col mt-5'>
            ...
            <div className="xl:w-[50%] flex flex-wrap">
              ...
              <div className="w-full p-2">
                <button className="mx-auto flex rounded border-0 bg-indigo-500 py-2 px-8 text-lg text-white hover:bg-indigo-600 focus:outline-none disabled:bg-indigo-900"  disabled={true}>Send</button>
              </div>
