...
function DefaultPrompt({currentPath,data=null}) {
  ...
  return (
    <>
      <div className=" text-blue-600"><span className='text-green-500'>┌──(</span>prasad@DevMachine<span className='text-green-500' >)-[<span className='text-white'>~</span><span className='text-white'>{curntPath!=='/' ? "/"+curntPath :""}</span>]</span></div>
      {/* <br /> */}
